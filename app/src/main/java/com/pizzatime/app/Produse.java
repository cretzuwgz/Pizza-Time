...
public class Produse extends ListFragment {
    /**
    ...
    private static String url_not = "http://pizzatime.webege.com/get_prod.php";
     ...
     * number.
     */
    public static Produse newInstance() {
        Produse fragment = new Produse();
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Incarcare produse...\nVa rugam asteptati.");
        ...
        protected String doInBackground(String... args) {
            ...
            params.add(new BasicNameValuePair("tip", Long.toString(Meniu.tip_ales)));
            // getting JSON string from URL
            JSONObject json = jParser.makeHttpRequest(url_not, "POST", params);
            ...
            try {
                ...
                products = json.getJSONArray(TAG_PRODUSE);
